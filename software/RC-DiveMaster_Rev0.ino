...
// Designed for https://www.thingiverse.com/thing:4560120 (Subnautica Cyclops Submarine)
...
int rcCount = 0;
int rcStack=0;      // Status of the RC-Connection >0 = not connected, 0 = connected
int pwmStack = 0;
...
// ok 
else if (tankEmpty !=1){  // status ok, if no emergency has been detected before
